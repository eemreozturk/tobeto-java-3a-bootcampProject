package com.example.bootcampProject.core.aspects.logging;
...
public class LogAspect {
    ...
    @Around("springBeanPointcut() && @annotation(com.example.bootcampProject.core.aspects.logging.Loggable)")
